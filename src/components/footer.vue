<template>
  <!-- Footer Container -->
  <div
    class="md:hidden sticky w-full mt-[50px] py-[20px] bg-main-dark border-solid border-t-[3px] border-accent border-opacity-50 z-20"
  >
    <!-- Social Links -->
    <ul class="w-1/3 mx-auto my-[10px] flex flex-row justify-around bg-inherit">
      ...
      <li class="w-[40px] bg-inherit">
        <a
          class="bg-inherit"
          href="https://github.com/AshikVarghese"
          target="”_blank”"
        >
          <svg
      ...
      <li class="w-[40px] bg-inherit">
        <a
          class="bg-inherit"
          href="https://www.instagram.com/ashik.vkt/"
          target="”_blank”"
        >
          <svg
            class="fill-main hover:fill-accent bg-inherit"
      ...
      <!-- X -->
      <li class="w-[40px] bg-inherit">
        <a class="bg-inherit" href="https://x.com/ashikvkt" target="”_blank”">
          <svg
            class="fill-main hover:fill-accent bg-inherit"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
          ...
          >
            <path
              d="M18.9 2H22L14.6 10.3L23.3 22H16.4L10.9 14.7L4.4 22H1.3L9.2 13.1L0.8 2H7.9L12.8 8.6L18.9 2ZM17.8 20H19.5L6.9 4H5.1L17.8 20Z"
            />
          </svg>
        </a>
      </li>
      ...
      <li class="w-[40px] bg-inherit">
        <a
          class="bg-inherit"
          href="https://www.linkedin.com/in/ashikvarghese/"
          target="”_blank”"
        >
          <svg
            class="fill-main hover:fill-accent bg-inherit"
    ...
    >
      Built by <span class="bg-inherit hover:text-accent">Ashik Varghese</span>
