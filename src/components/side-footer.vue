  ...
  <div class="nav-sm:hidden fixed mx-45px bottom-0 left-0 z-10">
    ...
    <ul class="my-20px bg-none">
      ...
      <li class="w-50px hover:scale-105">
        <a href="https://github.com/AshikVarghese" target="”_blank”">
          <svg
      ...
      <!-- Instagram -->
      <li class="w-50px hover:scale-105">
        <a href="https://www.instagram.com/ashik.vkt/" target="”_blank”">
          <svg
            class="fill-main hover:fill-accent"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
      ...
      <!-- X -->
      <li class="w-50px hover:scale-105">
        <a href="https://x.com/ashikvkt" target="”_blank”">
          <svg
            class="fill-main hover:fill-accent"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
      ...
      <!-- LinkedIn -->
      <li class="w-50px hover:scale-105">
        <a href="https://www.linkedin.com/in/ashikvarghese/" target="”_blank”">
          <svg
            class="fill-main hover:fill-accent"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
